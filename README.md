...
A low-latency, deterministic order book and matching engine designed for high-frequency prediction market arbitrage. Built in C++17, this engine focuses on strict hardware cache-line optimization and zero-allocation hot paths.
